    ...
    <div className={`${styles.page} ${isDarkTheme ? styles.darkMode : ""}`}>
      ...
      <div id="mainContent">
        <main className={styles.main}>
          <a
            href="https://github.com/FlonneReverie/flonne-portfolio-next"
            className={styles.githubSection}
            target="_blank"
            aria-label="View this portfolio's code on GitHub in a new tab"
          >
            <Image
              src="/github-mark.svg"
              width="48"
          ...
          />
          <p>
            Hello! My name is Flonne Reverie. I&apos;m a computer programmer and
            full-stack web developer with 8+ years of experience!
          </p>
          <p>
            <a
              className={styles.cvLink}
              href="/files/flonne-reverie-CV-2025-revised.pdf"
              target="_blank"
          ...
          <p className={styles.currentStatus}>
            Currently seeking hybrid/remote roles from Porto, Portugal! 🇵🇹
            (Already a legal resident!)
          </p>
        ...
        <footer className={styles.footer}>
          ...
          <a
            ...
            target="_blank"
            aria-label="Visit React website in a new tab"
          >
            <Image
              src="/react.svg"
              width="24"
          ...
          <a
            ...
            rel="nofollow noreferrer"
            target="_blank"
            aria-label="Visit Next.js website in a new tab"
          >
            <Image
